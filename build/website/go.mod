...
replace	github.com/modern-go/concurrent v0.0.0-20180228061459-e0a39a4cb421 => ./pkg/src/ithub.com/modern-go/concurrent
replace	github.com/modern-go/reflect2 v0.0.0-20180701023420-4b7aa43c6742 => ./pkg/src/github.com/modern-go/reflect2 
replace	github.com/ugorji/go/codec v1.1.7 => ./pkg/src/github.com/ugorji/go/codec
